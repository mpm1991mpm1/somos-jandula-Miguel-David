...
public class BaseClientException extends Exception
{
	 ...
	 * Serial Version UID
	 */
	private static final long serialVersionUID = 1644969802902796205L ;
	 ...
	 */
	public BaseClientException(int code, String message) 
	{
		super(message);
	 ...
	 */
	public BaseClientException(int code, String message, Exception exception) 
	{
